<div class="ui scrolling modal" id="article-evoluer">
	<i class="close icon"></i>
	<div class="header">
		Evoluer, ou comment rester flexible ?
	</div>
	<div class="content">
		<div class="description">
			...
			<div class="ui small header">« Et on peut faire autrement ? »</div>
			<p>Oui mais cela nécessite de changer beaucoup de choses ; voici notre aventure à Anaqua Services :</p>
			<p>Tout est parti du séminaire Agile Pays Basque où nous avons découvert de nouvelles opportunités que nous ne pouvions pas laisser passer.</p>
			<p>Deux semaines plus tard, Claude Aubry venait nous coacher sur Scrum avec son management visuel et ses cycles courts. Depuis, nous livrons tous les 15 jours, là où les projets prenaient avant des mois, voire des années.</p>
			<p>Mais cela a amené un autre problème, pour faire de l’itératif, il faut réécrire du code … et c’est dur… et ça prend beaucoup de temps … et du coup, on n’a pas envie de le faire.</p>
			<p>Nous suivons aujourd’hui la voie du Clean Code : « Tout morceau de code doit révéler son intention ». Pour atteindre cet idéal, on doit remanier le code sans arrêt ; les tests unitaires étant là pour nous assurer que nous n’avons pas tout cassé au passage.</p>
			
			<div class="ui small header">« Et si on doit livrer et qu’on n’a pas le temps de faire propre ? »</div>
			<p>Pas de soucis, nous faisons notre possible mais surtout, nous gardons à l’esprit que nous venons de produire un code difficilement maintenable et difficilement évolutif. On vient de créer une « dette technique » qui se payera le jour où la société voudra évoluer. Plus nous attendrons pour rembourser cette dette, plus elle coutera chère à l’entreprise.</p>
